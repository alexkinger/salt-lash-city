...
export type ServicePage = {
  ...
  intro: string;
  sections: { heading?: string; items: PricedService[] }[];
  careTips?: string[];
...
export const servicePages: ServicePage[] = [
  {
    ...
    intro:
      "If you’re looking for professional eyelash extensions near Sandy, UT, Salt Lash City is ready for you. Browse services below, reach out with questions, or book an appointment online.",
    sections: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            price: "$60",
            note: "Must book this option if you are coming from another lash artist so there’s more time to work on your lashes.",
          },
        ],
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            price: "$220",
            note: "Half classic (1:1) and half volume (3–6 lashes per natural lash) with your choice of length, thickness, curl, and shape.",
          },
        ],
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            price: "$220",
            note: "A fan of 3–6 thin synthetic mink lashes on one natural lash with your choice of length, thickness, curl, and shape.",
          },
        ],
      },
      {
    ...
    careTips: [
      ...
      "Keep clean by rinsing with cool water; if you wear eye makeup, brush through with Johnson’s baby shampoo after the first 24–48 hours, dab dry, and air dry before brushing.",
      "Do not over-brush — morning, midday, and before bed is plenty.",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Depending on aftercare and your natural lash cycle, lashes typically last 2–4 weeks before needing a fill.",
      },
      {
      ...
      },
      {
        ...
        answer: "Yes — after 24 hours you can get your lashes wet as usual.",
      },
    ],
  },
  {
    ...
    group: "eyelashes",
    shortDescription: "A low-maintenance lash perm that lasts 6–8 weeks.",
    intro:
      "Professional eyelash lifts near Sandy, UT — perfect if you want fabulous lashes with low maintenance.",
    sections: [
      {
        items: [
          {
            name: "Lash Lift",
            price: "$70",
            note: "A lash perm that leaves your lashes curled for 6–8 weeks.",
          },
          {
  ...
  },
  {
    ...
    group: "eyelashes",
    shortDescription: "Darker, fuller-looking lashes for weeks — even without mascara.",
    intro:
    ...
    faqs: [
      {
        ...
        answer: "Generally about 3–5 weeks, depending on your lashes.",
      },
      {
        question: "Can you still wear mascara with lash tint?",
        answer: "Yes — unlike extensions, you can wear mascara after a tint.",
      },
      {
  ...
  },
  {
    ...
    intro:
      "I offer a variety of sensitive, hard, and soft waxes for different body areas and skin types. Best to exfoliate a day before treatment and have hair about the length of a grain of rice (I will not trim). You’ll be cleansed before treatment; some swelling or redness afterward is possible.",
    sections: [
      {
        items: [
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes — regular facials and good aftercare can help treat acne and other skin concerns.",
      },
    ],
  },
];
...
export const homeServiceHighlights = [
  {
    ...
    description:
      "Darken, thicken, and lengthen your lashes with classic, volume, and hybrid options.",
    href: "/eyelash-extensions",
    icon: "/images/icon-lashes.png",
  },
  {
